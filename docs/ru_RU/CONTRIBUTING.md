...
[english](https://github.com/TanyaEleventhGoddess/go_mtproto/blob/main/.github/CONTRIBUTING.md) **русский**
...
А еще мы вообще-то хотим сделать [ЧеКаво](https://github.com/TanyaEleventhGoddess/go_mtproto/discussions/categories/q-a), но не знаем, какие вопросы туда писать, так что, если вы это читаете, наверное, пишите пока в телегу, там разберемся :)
